        ...
        <div class="overflow-x-auto">
            <table class="w-full border border-gray-200 rounded-lg">
                ...
                <tr>
                    ...
                    <th class="px-6 py-3 text-left">Ball</th>
                ...
                @foreach($criterions as $criterion)
                    <tr class="border-b hover:bg-gray-50 dark:bg-gray-700 text-black dark:text-white">
                        ...
                        <td class="px-6 py-4">{{ $criterion->score }}</td>
                        <td class="px-6 py-4 flex justify-center gap-4">
                            <a href="{{ route('criterion.edit', $criterion->id) }}" class="bg-green-500 hover:bg-green-400 text-white font-bold py-2 px-4 border-b-4 border-blue-700 hover:border-blue-500 rounded">
                                Edit
                            </a>
                            <form action="{{ route('criterion.destroy', $criterion->id) }}" method="POST" onsubmit="return confirm('Mezonni o\'chirishni xohlaysizmi?');">
                                @csrf
                                @method('DELETE')
