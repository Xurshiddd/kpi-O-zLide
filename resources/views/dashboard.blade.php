                    ...
                    <div class="relative overflow-x-auto">
                        ...
                        <table class="text-left w-full whitespace-nowrap text-sm text-gray-500">
                            ...
                            <tr>
                                <td class="p-4 text-sm">
                                    <div class="flex gap-6 items-center">
                                        <div class="h-12 w-12 inline-block"><img src="{{ asset('assets/images/profile/user-1.jpg') }}" alt="" class="rounded-full w-100"></div>
                            ...
                            <tr>
                                <td class="p-4 text-sm">
                                    <div class="flex gap-6 items-center">
                                        <div class="h-12 w-12 inline-block"><img src="{{ asset('assets/images/profile/user-2.jpg') }}" alt="" class="rounded-full w-100"></div>
                                        <div class="flex flex-col gap-1 text-gray-500">
                            ...
                            <tr>
                                <td class="p-4 text-sm">
                                    <div class="flex gap-6 items-center">
                                        <div class="h-12 w-12 inline-block"><img src="{{ asset('assets/images/profile/user-3.jpg') }}" alt="" class="rounded-full w-100"></div>
                                        <div class="flex flex-col gap-1 text-gray-500">
                            ...
                            <tr>
                                <td class="p-4 text-sm">
                                    <div class="flex gap-6 items-center">
                                        <div class="h-12 w-12 inline-block"><img src="{{ asset('assets/images/profile/user-4.jpg') }}" alt="" class="rounded-full w-100"></div>
                                        <div class="flex flex-col gap-1 text-gray-500">
